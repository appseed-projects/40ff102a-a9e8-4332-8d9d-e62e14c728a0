...
- Timestamp: `2022-06-10 10:17`
- Build ID: `40ff102a-a9e8-4332-8d9d-e62e14c728a0`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/40ff102a-a9e8-4332-8d9d-e62e14c728a0.git
$ cd 40ff102a-a9e8-4332-8d9d-e62e14c728a0
```
